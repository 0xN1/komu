...
// Custom hook for horizontal scrolling with mouse wheel + with support for trackpad
...
const ResourcesPage = () => {
  ...
  const { filteredResources, loading: resourcesLoading } =
    useResourcesByTag(selectedTag);
    ...
    <div className="w-full flex flex-col gap-4 p-4 relative -mt-12">
      ...
      <div className="flex flex-col gap-2 w-full relative">
        <div className="flex flex-col gap-2 w-screen absolute inset-0 -ml-12 sm:-ml-24 pointer-events-none">
          ...
          >
            {shuffledTags
              .slice(0, Math.ceil(shuffledTags.length / 3))
              .map((tag, index) => (
